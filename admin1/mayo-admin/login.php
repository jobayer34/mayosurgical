...
$dbh = new PDO('mysql:host=localhost;dbname=arvsush_mayo', 'arvsush_mayo', 'mayo@123');
...
{	
	...
	{	
		setcookie("username", $username, time()+7600); //here we are setting a cookie named username, with the Username on the database that will last 48 hours and will be set on the understandesign.com domain. This is an optional parameter.	 
		header("Location:users");
		//exit();
	}
...
<form  action="" method="post" name="form-login" id="regform">
	...
	<label for="remember">Remember Me: <input type="checkbox" name="remember" value="yes"/></label>
