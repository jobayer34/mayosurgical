...
<head>
	...
	<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/mayo/style.css" type="text/css"/>
	...
	<div class="primary_nav">
		<div class="container">
			<div class="primary_nav_left">
				...
				<div class="menu_bg">
					<ul>
						...
						<li><a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/client/signup.php">Registration</a></li>
					</ul>
				</div>
			...
			<div class="login_button">
				...
				<h1><a href="http://<?php echo $_SERVER['HTTP_HOST'];?>/mayo/client/login.php">Login</a></h1>
			</div>
		</div>
	</div>
	<!--<div class="container">
